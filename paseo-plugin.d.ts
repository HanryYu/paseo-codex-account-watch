// Paseo plugin types: Copyright (c) 2025-present Mohamed Boudra. Apache-2.0.
...
declare module "@getpaseo/plugin" {
  ...
  > = ItemType extends AgentTimelineItem["type"]
    ...
    : never;
  export interface PluginTimelineItemProps<
    Data = unknown,
  > extends PluginHostProps {
    agentId: string;
    item: { type: "plugin"; kind: string; version: number; data: Data };
    timestamp: Date;
  }
  export interface PluginTimelineRendererContribution<
  ...
  export type PluginClientContribution = (
  ...
  export interface PluginContext {
    ...
    addCommandCenterItem(
      contribution: PluginCommandCenterItemContribution,
    ): void;
